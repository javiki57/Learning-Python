...
class SimpleTextEditor:
    def __init__(self, root):
            ...
            self.text_area.pack(fill=tk.BOTH, expand=1) # Expandir más allá de los límites
...
menu_options.add_command(label="Salir", command=editor.quit_confirm) # Ventana para confirmar si quieres salir o no
