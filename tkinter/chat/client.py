...
def client_program():
    ...
    text_widget = ScrolledText(window, state='disabled') # Para que no se pueda escribir, al menos de momento
    text_widget.pack(padx=5, pady=5)

    frame_widget = Frame(window)
    frame_widget.pack(padx=5, pady=2, fill=BOTH, expand=1)

    entry_widget = Entry(frame_widget, font=('Times New Roman', 14))
